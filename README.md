...
In the meantime, you can download it from Google Drive - it will always be the most recent version. 

If you like the deck and want to show some support, you can rate it on Ankiweb and give the GitHub repo a star, Thank you ❤️
...
<p align="center">
  <strong>Front example</strong>
</p>

<p align="center"> <img src="korean/grammar/screenshots/altfront1.png" alt="Front Example"> </p>


<p align="center">
  <strong>Back example</strong>
</p>

<p align="center"> <img src="korean/grammar/screenshots/altback1_3.png" alt="Back Example"> </p>
...
The deck include a <strong>USER CONFIGURATION AREA</strong> directly inside the <strong>Front</strong> and <strong>Back</strong> JavaScript of the cards.     

This section allows you to customize the deck behavior and appearance (for example: display options, fonts, or other variables).    
...
**I encourage you to try out [Kimchi Reader](https://kimchi-reader.app/) !**   
